    ...
    <div className="hamburger-overlay-container" className={showHideClassName}>
      ...
      <div className="hamburger-list-container">
        <div className="overlay-divider-line">
          ...
          <ul>
            <li href="/" onClick={handleClose}>
              Home
            </li>
            {/* <li href="/work" onClick={() => window.open('http://sizzle.wearered.com', "_blank")}>Latest Work</li>*/}
            <li href="/velvet" onClick={handleClose2}>
              Discover Velvet
            </li>

            <li href="/contact" onClick={handleClose4}>
              Contact Us
            </li>
          ...
          <img className="overlay-close-icon" src="assets/images/X.png" onClick={handleClose} />
        </div>
      </div>
    </div>
  );
